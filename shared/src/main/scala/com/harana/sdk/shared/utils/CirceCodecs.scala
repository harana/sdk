...
object CirceCodecs {
	...
	implicit val parameterGroupEncoder: Encoder.AsObject[ParameterGroup] = deriveEncoder[ParameterGroup]
	implicit val parameterGroupDecoder: Decoder[ParameterGroup] = deriveDecoder[ParameterGroup]
