...
object AuthenticationHandler {
	...
	def apply(name: String, description: String, parameterValues: Map[ParameterName, Any], createdBy: Option[User], visibility: Visibility, tags: Set[String]): AuthenticationHandler = {
